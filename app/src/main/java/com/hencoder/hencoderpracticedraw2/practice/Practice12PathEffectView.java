...
public class Practice12PathEffectView extends View {
    ...
    Path path = new Path();
    CornerPathEffect cornerPathEffect = new CornerPathEffect(20f);
    DiscretePathEffect discretePathEffect = new DiscretePathEffect(20f, 5f);
    DashPathEffect dashPathEffect = new DashPathEffect(new float[]{20, 10, 5, 10}, 0f);
